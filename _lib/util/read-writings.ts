export const getUrl = (title: string) =>
  `https://raw.githubusercontent.com/chat-ting/writings/refs/heads/main/__writings/${title}`

const response = await fetch(
  'https://raw.githubusercontent.com/chat-ting/writings/refs/heads/main/__writings/writings.map.json'
)
